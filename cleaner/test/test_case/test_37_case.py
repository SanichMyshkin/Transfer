...
# ======== TEST CASE 37: REPOSITORY ========
def test_repository_case37():
    components = [
        # MATCH (reserved=1, min_days=5, retention=None)
        make_component(
        ...
        # NO-MATCH (reserved=1, min_days=5, retention=None)
        make_component(
...
def test_maven_case37():
    ...
    maven_rules = {
        "release": {
            "regex_rules": {"^1.*": {"reserved": 1, "min_days_since_last_download": 5}},
    ...
    # NO-MATCH: 2.0.1 (reserved), 2.0.2 (dl<5)
