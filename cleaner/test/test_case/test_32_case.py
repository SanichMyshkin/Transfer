...
# ======== TEST CASE 32: REPOSITORY ========
def test_repository_case32():
    components = [
        # MATCH (retention=7)
        ...
        # NO-MATCH (нет правил → все сохраняем)
        make_component("compB", "random-1", last_modified_days_ago=1),
        make_component("compB", "random-2", last_modified_days_ago=15),
    ]
