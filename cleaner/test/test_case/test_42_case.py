...
# ======== TEST CASE 42: REPOSITORY ========
def test_repository_case42():
    components = [
        # MATCH
        ...
        # NO-MATCH
        make_component("compB", "random-1", last_modified_days_ago=1),  # reserved → сохраняем
        make_component("compB", "random-2", last_modified_days_ago=3),  # age < retention → сохраняем
        make_component("compB", "random-3", last_modified_days_ago=10), # age > retention → удаляется
    ]
