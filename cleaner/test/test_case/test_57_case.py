...
def test_repository_case57():
    components = [
        ...
        make_component("compB", "random-2", 5, 2),  # age=5 < 7 → сохраняем
        make_component(
            "compB", "random-3", 20, 10
        ),  # age=20 > 7, dl=10 > 5 → удаляется
    ]
