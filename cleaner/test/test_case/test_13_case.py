...
# ======== TEST CASE 13: NO-MATCH (repository) ========
...
# ======== TEST CASE 13: MATCH (maven) ========
def test_maven_case13_match():
    components = [
...
# ======== TEST CASE 13: NO-MATCH (maven) ========
def test_maven_case13_no_match():
    components = [
        make_maven_component("org.test", "libB", "2.0.0", last_modified_days_ago=1, last_download_days_ago=1),   # reserved
        make_maven_component("org.test", "libB", "2.0.1", last_modified_days_ago=2, last_download_days_ago=2),   # dl=2 < 3 → сохраняем
        make_maven_component("org.test", "libB", "2.0.2", last_modified_days_ago=10, last_download_days_ago=5),  # dl=5 > 3 → удаляем
    ]
