...
# ======== TEST CASE 46: REPOSITORY ========
def test_repository_case46():
    components = [
        # MATCH
        make_component(
        ...
        make_component("compB", "random-2", last_modified_days_ago=5),  # удаляется
        make_component("compB", "random-3", last_modified_days_ago=10),  # удаляется
    ]
