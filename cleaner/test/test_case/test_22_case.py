...
# ======== TEST CASE 22: REPOSITORY ========
def test_repository_case22():
    components = [
        make_component(
    ...
    assert set(deleted_versions) == {"dev-3", "random-2", "random-3"}


# ======== TEST CASE 22: MAVEN ========
def test_maven_case22():
    now = datetime.now(timezone.utc)
    components = [
        {
            "group": "org.test",
    ...
    assert set(deleted_versions) == {"1.0.2", "2.0.1", "2.0.2"}
