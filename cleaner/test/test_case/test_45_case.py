...
# ======== TEST CASE 45: REPOSITORY ========
def test_repository_case45():
    components = [
        # MATCH
        make_component(
        ...
        make_component(
            "compB", "random-3", last_modified_days_ago=7, last_download_days_ago=20
...
def test_maven_case45():
    ...
    components = [
        ...
        },  # dl < min_days → сохраняем
        {
            ...
            "assets": [
                {
                    "lastModified": (now - timedelta(days=7)).isoformat(),
