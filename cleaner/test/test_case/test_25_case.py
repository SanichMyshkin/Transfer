...
# ======== TEST CASE 25: REPOSITORY ========
def test_repository_case25():
    components = [
        # MATCH
        make_component(
        ...
        ),  # age>no_match_retention, dl>no_match_min_days → удаляется
    ]

    regex_rules = {"^dev-": {"retention_days": 7}}  # без reserved
