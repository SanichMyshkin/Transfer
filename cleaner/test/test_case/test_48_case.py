...
# ======== TEST CASE 48: REPOSITORY ========
def test_repository_case48():
    components = [
        # MATCH
        make_component(
        ...
        # NO-MATCH
        make_component("compB", "random-1", last_modified_days_ago=3),
        make_component("compB", "random-2", last_modified_days_ago=5),
        make_component("compB", "random-3", last_modified_days_ago=7),
    ]
